...
// // const MuiGridComponent = ({ items = [] }: GridProps) => (
...
// //         ],
// //       },
// //       render: (componentApi: any) => (
// //         <MuiGridComponent items={componentApi?.props?.items} />
// //       ),
// //     },
// //   },
// // };
...
// //                         <Button type="submit" sx={{ mt: 0, justifySelf: 'start' }} variant="outlined" color="secondary" startIcon={<SortIcon />}> مرتب کردن </Button>
// //                         <Button onClick={() => setIsRequestOpen(true)} sx={{ mt: 0, justifySelf: 'start' }} variant="contained" color="primary" startIcon={<AddCircleIcon />}> نمودار جدید </Button>
// //                       </Stack>
// //                     ),
// //                   },
// //                 ],
...
// //               config={config}
// //               data={{
// //                 content: [{ type: 'MuiGrid', props: {} }],
// //               }}
// //               onPublish={(data) => console.log('دیتا ذخیره شد:', data)}
// //             />
// //           <ChartRequestDialog
// //             open={isRequestOpen}
...
// type GridItem = { id: string; title: string; content: any; size?: 'small' | 'large' };
...
//       "empty_result": false
//   }},
//     { id: '4', title: 'آیتم ۴', size: 'large', content:{
//       "pending_chart_id": "f1bd2dcb-593c-4cd9-a29d-69e4f6fc214e",
//       "chart_type": "line_chart",
//       "fields_mapping": {
//           "x": {
...
//       "empty_result": false
//   }},
//     { id: '2', title: 'آیتم 2', size: 'small', content:{
...
//     { id: '3', title: 'آیتم 3', size: 'small', content:{
//       "pending_chart_id": "c1644af7-c71a-4e9c-b33e-98f4abcb7cc9",
//       "chart_type": "pie_chart",
//       "fields_mapping": {
//           "category": {
...
//                         <Grid item p={4}
//                           xs={12} sm={12}
//                           md={item.size === 'large' ? 12 : (item.content.chart_type === 'bar_chart' ? 12 : item.content.chart_type === 'line_chart' ? 12 : 6)}
//                           lg={item.size === 'large' ? 12 : (item.content.chart_type === 'bar_chart' ? 12 : item.content.chart_type === 'line_chart' ? 12 : 6)}
//                           xl={item.size === 'large' ? 12 : (item.content.chart_type === 'bar_chart' ? 12 : item.content.chart_type === 'line_chart' ? 12 : 6)}
//                           sx={{
//                             border: '2px dashed',
//                             borderColor: 'divider',
//                             borderRadius: 2,
//                             minHeight: item.size === 'large' ? 520 : 380,
...
//             items={items.map(({ id, title, size }) => ({ id, title, size }))}
