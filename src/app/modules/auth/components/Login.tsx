...
import { login, getLoggedUser, getUserDetails } from '../../../services/ApiRequests/Auth';
import {
  Box,
  Button,
  Container,
    ...
    <Container component="main" maxWidth="xs">
      ...
      >
        ...
        <Box component="form" onSubmit={formik.handleSubmit} sx={{ mt: 1, width: '100%' }}>
          ...
          <Button type="submit" fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} disabled={formik.isSubmitting || !formik.isValid || loading}>
